...
class CreateRenewWorkerFormsHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.renew_worker_forms_history', function (Blueprint $table) {
            $table->id();
...
//            $table->unsignedBigInteger('application_type')->comment("1:New Register, 2:Renewal")->nullable();
    ...
    {
        Schema::dropIfExists('renew_worker_forms_history');
    }
}
