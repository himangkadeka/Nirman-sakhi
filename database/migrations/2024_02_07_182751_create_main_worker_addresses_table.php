...
class CreateMainWorkerAddressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.main_worker_addresses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('Worker.main_worker_addresses');
    }
}
