...
class CreateMainWorkerFormsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.main_worker_forms', function (Blueprint $table) {
            $table->id();
...
//            $table->string('last_subscription_date')->nullable();
            ...
            $table->timestamp('hro_approval_time')->nullable();
            $table->timestamp('forward_to_da')->nullable();
            $table->timestamp('forward_to_ro')->nullable();
            $table->timestamp('send_back_to_ro')->nullable();
    ...
    {
        Schema::dropIfExists('Worker.main_worker_forms');
    }
}
