...
class CreateTemporaryWorkerBasicDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.temporary_worker_basic_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('Worker.temporary_worker_basic_details');
    }
}
