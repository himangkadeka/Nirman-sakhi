...
class CreateMigrantWorkerDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.migrant_worker_data', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('migrant_worker_data');
    }
}
