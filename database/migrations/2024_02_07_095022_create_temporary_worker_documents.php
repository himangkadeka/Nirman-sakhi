...
class CreateTemporaryWorkerDocuments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Worker.temporary_worker_documents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('Worker.temporary_worker_documents');
    }
}
