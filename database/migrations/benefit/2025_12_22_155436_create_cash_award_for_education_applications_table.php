...
class CreateCashAwardForEducationApplicationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Benefit.cash_award_for_education_applications', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('Benefit.cash_award_for_education_applications');
    }
}
