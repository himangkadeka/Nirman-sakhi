...
<div class="container">
    ...
    <table>
        ...
        <tr class="row-dark">
            <td>ID Card No : {{$worker_details->id_card}}</td>

        </tr>
        <tr class="row-light">

            <td>ID Card Validity Date : {{\Carbon\Carbon::parse($worker_details->id_card_expiry_date)->format('d-m-Y') }}</td>
            <td>Renewal Date : {{\Carbon\Carbon::parse($worker_details->renewal_date)->format('d-m-Y') }}</td>
            <td>Date Of Retirement : {{\Carbon\Carbon::parse($worker_details->basicDetail->date_of_retirement)->format('d-m-Y') }}</td>
        </tr>
        <tr>
            Office of Application : {{$worker_details->officeName->office_name}}
        </tr>
    </table>
    ...
    <table>
        <tr class="row-dark">
            ...
            <td style="white-space: normal; word-wrap: break-word; width: 50%;">
                <strong>Branch Name:</strong> {{ $worker_details->bankDetail->branch_name ?? 'NA' }}
            </td>
            <td style="white-space: normal; word-wrap: break-word; width: 50%;">
                <strong>Address:</strong> {{ $worker_details->bankDetail->bank_address ?? 'NA' }}
            </td>
        </tr>
        <tr class="row-light">
    ...
    <h4>Working Record Book Details</h4>
    <table>
        <thead>
        <tr class="row-dark">
