...
@section('title',' Update | Existing Schemes')
    ...
    <div class="container-fluid mb-4" >
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="custom-container">
                        <div class="custom-flex-container">
                            <div class="custom-left-content">
                                <h6 class="custom-heading">{{ trans('worker-registration/worker-schemes-details.reg') }}</h6>
                                <h6 class="custom-bold">
                                    <i class="custom-icon fas fa-file-alt pr-2"></i>{{ trans('worker-registration/worker-schemes-details.appno') }} -
                                    {{ $application_no }}
                                </h6>
                            </div>
                ...
                <span>
                    <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; {{ trans('worker-registration/worker-schemes-details.updateschemes') }}
                </span>
                                </div>
                                <form method="post" id="dynamic_field" action="{{ route('update-existing-scheme') }}" class="ml-2 mr-2" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="table-container">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="bold">{{ trans('worker-registration/worker-schemes-details.regdate') }}<span class="text-danger">*</span></th>
                                                        ...
                                                        @foreach ($tws as $twsf)
                                                            <tr>
                                                                ...
                                                                <td class="fixed">
                                                                    <input type="text" name="registration_id[]" value="{{ $twsf->registration_id }}" class="form-control" placeholder="Enter Registration No"/>
                                                    ...
                                                    <button type="button" name="add" id="add" class="btn btn-sm btn-info mt-3"><i class="fa fa-plus-circle"></i>&nbsp;Add New Row</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                            <a type="submit" href="{{route('submit-existing-family-details')}}"--}}
