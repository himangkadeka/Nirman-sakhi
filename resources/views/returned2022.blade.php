...
@section('title', 'Benefits returned 2022')
        ...
        <div class="container">
            <div class="pagination text-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Year 2022</li>
                    </ol>
                </nav>
            </div>
            <div class="sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" onclick="showTab('lakhimpur')">Lakhimpur (2022) &rsaquo;</a>
            ...
            <div class="content">
                <div id="home" class="tab-content active">
                    <h4>BENEFITS RETURNED IN THE YEAR 2022</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Labour Officer, Lakhimpur | Labour Inspector, Nowboicha | Labour Inspector, Narayanpur :: Educational Assistance </td>
                                {{-- <td id="fileSizeBongaigaon">Loading...</td> --}}
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2024.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'FWD_Resubmission_of_documents_for_credit_of_Educational_Assistance_amount_Lakhimpur.pdf') }}"
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Annexure_A_2.pdf') }}"
                                        id="pdfLinkLakhimpur">Return Letter</a></td>
                            </tr>
