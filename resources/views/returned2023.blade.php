...
@section('title', 'Benefits returned 2023')
...
@section('content')
    ...
    <section class="background">
        <div class="container">
            ...
            <div class="sidebar">
                <nav class="nav flex-column">   <a class="nav-link active" onclick="showTab('home')">Home&rsaquo;</a><a class="nav-link" onclick="showTab('tinsukia')">Tinsukia (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('cachar')">Cachar (2023) &rsaquo;</a>

                    {{-- Documents not got --}}
                    {{--

                    <a class="nav-link" onclick="showTab('barpeta')">Barpeta (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('biswanath')">Biswanath (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('bongaigaon')">Bongaigaon (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('darrang')">Darrang (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('dhubri')">Dhubri (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('dibrugarh')">Dibrugarh (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('golaghat')">Golaghat (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('jorhat')">Jorhat (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('kamrup')">Kamrup (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('kamrupmetro')">Kamrup Metro (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('karbianglong')">Karbi Anglong (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('karimganj')">Karimganj (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('lakhimpur')">Lakhimpur (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('morigaon')">Morigaon (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('nagaon')">Nagaon (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('sivasagar')">Sivasagar (2023) &rsaquo;</a>

                    <a class="nav-link" onclick="showTab('udalguri')">Udalguri (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('westkarbianglong')">West Karbi Anglong (2023) &rsaquo;</a>


                    <a class="nav-link" onclick="showTab('hailakandi')">Hailakandi (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('nalbari')">Nalbari (2023) &rsaquo;</a>



                    <a class="nav-link" onclick="showTab('kaliabor')">Kaliabor (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('hojai')">Hojai (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('dimahasao')">Dima Hasao	 (2023) &rsaquo;</a>



                    <a class="nav-link" onclick="showTab('goalpara')">Goalpara (2023) &rsaquo;</a>



                    <a class="nav-link" onclick="showTab('nalbari')">Rangia (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('bongaigaon')">Gossaigaon	 (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('hailakandi')">Sorbhog (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('nalbari')">Sonitpur (2023) &rsaquo;</a>
                    ...
                    <a class="nav-link" onclick="showTab('hailakandi')">Majuli (2023) &rsaquo;</a>


                    <a class="nav-link" onclick="showTab('hailakandi')">Dhemaji (2023) &rsaquo;</a>


                    <a class="nav-link" onclick="showTab('bongaigaon')">Charaideo (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('hailakandi')">Bajali	 (2023) &rsaquo;</a>
                    <a class="nav-link" onclick="showTab('nalbari')">Kokrajhar (2023) &rsaquo;</a>
            ...
            <div class="content">
                <div id="home" class="tab-content active">
                    <h4>BENEFITS RETURNED IN THE YEAR 2023</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter_Brapeta_Dist_Death_Benefit_2023.pdf') }}"
                                        id="pdfLinkBarpeta">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="returnletter"><a href="{{ route('download', 'DB_LO_Biswanath_18_10_2023.pdf') }}"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter_Dhubri_dist_Death_Benefit_2023.pdf') }}"
                                        id="pdfLinkDhubri">Return Letter</a></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a href="{{ route('download', 'ALC_DIB_DB_05_08_2023.pdf') }}"
                            ...
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'ALC_DIB_Maternity_19_10_2023.pdf') }}"
                                        id="pdfLinkDibrugarh">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoDibrugarh"></td>
                            ...
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'MA_LI_Joypur_return_09_12_2023.pdf') }}"
                                        id="pdfLinkDibrugarh">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div id="golaghat" class="tab-content sticky-top bg-white p-2 ">
                    <h2>Golaghat (2023)</h2>
                    <div class="last-updated">Last Updated on: <span id="lastUpdatedGolaghat"></span></div>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Sno.</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'LI_SPR_Maternity_2023_rtrn_letter_29_11_24.pdf') }}"
                                        id="pdfLinkGolaghat">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoGolaghat"></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td id="fileSizeHailakandi">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'LI_Titabor_MA_21_08_2023.pdf') }}"
                                        id="pdfLinkJorhat">Return Letter</a></td>
                            ...
                            <tr>
                                ...
                                {{-- <td id="fileSizeHailakandi">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter_of_death_benefit_Titabor_04_11_2023.pdf') }}"
                                        id="pdfLinkJorhat">Return Letter</a></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a href="{{ route('download', 'DB_LI_Rangia_4_12_2023.pdf') }}"
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Clarification_letter_ALC_Kamrup_M_05_11_2023.pdf') }}"
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter_Kamrup_M_dist_Death_benefit_2023.pdf') }}"
                                        id="pdfLinkKamrupMetro">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'LO_Karimganj_MA_27_08_2023.pdf') }}"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'LI_Narayanpur_MA_return_20_08_2023.pdf') }}"
                                        id="pdfLinkLakhimpur">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoLakhimpur"></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'returned_EA_LO_Morigaon_23_10_2023.pdf') }}"
                                        id="pdfLinkMorigaon">Return Letter</a></td>
                            ...
                            <tr>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter_morigaon_dist_Educational_Assistance_2023.pdf') }}"
                                        id="pdfLinkMorigaon">Return Letter</a></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'MA_ALC_NAGAON_return_09_12_2023.pdf') }}"
                                        id="pdfLinkNagaon">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoNagaon"></td>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'MA_return_batadrava_23_12_2023.pdf') }}"
                                        id="pdfLinkNagaon">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                <td class="returnletter"><a href="{{ route('download', 'ANNEXURE_A_5.pdf') }}"
                            ...
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                        <td class="returnletter"><a href="{{ route('download', 'ANNEXURE_B_3.pdf') }}"
                                            id="pdfLinkTinsukia">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoTinsukia"></td>
                                <td>Resubmission of documents :: Educational Assistance amount</td>
                                {{-- <td id="fileSizeBongaigaon">Loading...</td> --}}
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                        <td class="returnletter"><a href="{{ route('download', 'FWD_Resubmission_of_documents_for_credit_of_Educational_Assistance_amount.pdf') }}"
                                            id="pdfLinkTinsukia">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeHailakandi">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Clarification_letter_LI_khoirabari_05_11_2023.pdf') }}"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a href="{{ route('download', 'EA_LO_Hamren_4_12_2023.pdf') }}"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>ANNEXURE A , Silchar </td>

                                <td class="returnletter"><a
                                        href="{{ route('download', 'ANNEXURE_A_Silchar.pdf') }}"
                                        id="pdfLinkCachar">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoCachar"></td>
                                <td>ANNEXURE B , Silchar </td>

                                <td class="returnletter"><a
                                        href="{{ route('download', 'ANNEXURE_B_Silchar.pdf') }}"
                                        id="pdfLinkCachar">Return Letter</a></td>
                            </tr>
                            <tr>
                                <td class="snoCachar"></td>
                                ...
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Fwd_Resubmission_of_documents_for_credit_of_Educational_Assistance_amount_Silchar.pdf') }}"
                                        id="pdfLinkCachar">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeHailakandi">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter-Hailakandi_Dist_2023.pdf') }}"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td id="fileSizeNalbari">Loading...</td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter-Nalbari_dist_2023.pdf') }}"
                        ...
                        <tbody>
                            <tr>
                                ...
                                {{-- <td><a href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon"><i class="fa fa-file-pdf-o text-danger"></i></a></td> --}}
                                <td class="returnletter"><a
                                        href="{{ route('download', 'Return_letter-Bongaigaon_dist_2023.pdf') }}"
                                        id="pdfLinkBongaigaon">Return Letter</a></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let snoDibrugarhIndex = 1;
            let snoGolaghatIndex = 1;
            let snoJorhatIndex = 1;
            let snoKamrupIndex = 1;
            let snoKamrupMetroIndex = 1;
            let snoKarbiAnglongIndex = 1;
            let snoKarimganjIndex = 1;
            let snoLakhimpurIndex = 1;
            let snoMorigaonIndex = 1;
            let snoNagaonIndex = 1;
            let snoSivasagarIndex = 1;
            let snoTinsukiaIndex = 1;
            let snoUdalguriIndex = 1;
            let snoWestKarbiAnglongIndex = 1;


            let snoCacharIndex = 1;
            ...
            rows.forEach((row) => {
                ...
                const snoDibrugarhCell = row.querySelector('.snoDibrugarh');
                if (snoDibrugarhCell) {
                    snoDibrugarhCell.textContent = snoDibrugarhIndex++;
                }
                const snoGolaghatCell = row.querySelector('.snoGolaghat');
                if (snoGolaghatCell) {
                    snoGolaghatCell.textContent = snoGolaghatIndex++;
                }
                const snoJorhatCell = row.querySelector('.snoJorhat');
                if (snoJorhatCell) {
                    snoJorhatCell.textContent = snoJorhatIndex++;
                }
                const snoKamrupCell = row.querySelector('.snoKamrup');
                if (snoKamrupCell) {
                    snoKamrupCell.textContent = snoKamrupIndex++;
                }
                const snoKamrupMetroCell = row.querySelector('.snoKamrupMetro');
                if (snoKamrupMetroCell) {
                    snoKamrupMetroCell.textContent = snoKamrupMetroIndex++;
                }

                const snoKarbiAnglongCell = row.querySelector('.snoKarbiAnglong');
                if (snoKarbiAnglongCell) {
                    snoKarbiAnglongCell.textContent = snoKarbiAnglongIndex++;
                }
                ...
                const snoLakhimpurCell = row.querySelector('.snoLakhimpur');
                if (snoLakhimpurCell) {
                    snoLakhimpurCell.textContent = snoLakhimpurIndex++;
                }
                ...
                const snoSivasagarCell = row.querySelector('.snoSivasagar');
                if (snoSivasagarCell) {
                    snoSivasagarCell.textContent = snoSivasagarIndex++;
                }
                const snoTinsukiaCell = row.querySelector('.snoTinsukia');
                if (snoTinsukiaCell) {
                    snoTinsukiaCell.textContent = snoTinsukiaIndex++;
                }
                const snoUdalguriCell = row.querySelector('.snoUdalguri');
                if (snoUdalguriCell) {
                    snoUdalguriCell.textContent = snoUdalguriIndex++;
                }
                const snoWestKarbiAnglongCell = row.querySelector('.snoWestKarbiAnglong');
                if (snoWestKarbiAnglongCell) {
                    snoWestKarbiAnglongCell.textContent = snoWestKarbiAnglongIndex++;
                }
                const snoCacharCell = row.querySelector('.snoCachar');
                if (snoCacharCell) {
                    snoCacharCell.textContent = snoCacharIndex++;
                }
