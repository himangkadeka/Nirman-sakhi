<div class="modal fade" id="edit-sub-district-modal">
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header text-center d-block p-2 border-bottom-0 bg-dark text-light">
                ...
                <h4 class="text-light">EDIT SUB DISTRICT</h4>
            ...
            <div class="modal-body">
                ...
                <form action="{{route('admin.sub-districts.update')}}" id="edit-sub-district-form" method="POST" class="w-sm-100 w-auto mx-auto needs-validation master-data-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control state_code_select" id="edit_state_code_select" name="state_code" required>
                    ...
                    <div class="form-group w-100">
                        ...
                        <select class="form-control district_codes" id="edit_district_code" name="district_code" required>
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="text" class="form-control" id="edit-sub-district-code" pattern="[0-9]+" name="subdistrict_code" value="{{ old('subdistrict_code')}}" readonly required>
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="text" class="form-control" id="edit-sub-district-name" name="subdistrict_name" value="{{ old('subdistrict_name') }}" required>
