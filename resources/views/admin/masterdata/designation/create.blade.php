<div class="modal fade" id="designation-add-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center d-block p-2 border-bottom-0 bg-dark text-light">
                <h4 class="text-light">ADD DESIGNATION</h4>
                <button type="button" class="close position-absolute" style="right: 15px; top: 8px;" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div id="role-msg"></div>
                <form id="designation-add-form" action="{{Route('admin.designations.store')}}" method="POST" class="w-sm-100 w-auto mx-auto master-data-form">
                    @csrf
