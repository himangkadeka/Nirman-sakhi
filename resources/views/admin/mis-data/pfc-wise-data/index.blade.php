...
@section('title', 'Admin | CSC Wise Data')
@section('breadcrumb_item_1', 'MIS Data')
@section('breadcrumb_item_2', 'CSC Wise Data')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="mb-3">
            <a href="{{ route('admin.pfcwise.district') }}"
            ...
            <div class="col-md-12 table-responsive">
                <form method="GET" action="{{ route('admin.pfcwise.index') }}" class="mb-3">
                    <div class="input-group my-3">
                        ...
                        <div class="col-3">
                            <input type="text" name="search" class="form-control" placeholder="Search by CSC ID"
                    ...
                    <tbody>
                        @foreach ($pfcs as $pfc)
                            <tr>
                                ...
                                <td>{{ $pfc->kiosk_registration_id}}</td>
                                <td>{{ $pfc->user_type }}</td>
