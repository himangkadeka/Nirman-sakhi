                            ...
                            @if ($worker_details->already_registered == 1)
                                @if ($cardData)
                                    <div class="form-group col-md-3">
                                        ...
                                        <span class="form-control-plaintext">{{ $cardData->worker_id }}</span>
            ...
            <table class="table">
                ...
                @if ($worker_details->already_registered == 1)
                    <tr>
                        ...
                        <td>BOC ID Card</td>
                        <td><a href="{{ route('boc-card', ['worker_id' => encrypt($worker_details->worker_id)]) }}"
                               class="href" target="_blank"><i class="fa fa-external-link"
                                                               aria-hidden="true"></i>&nbspView Attachment</a></td>
                ...
                @if (!$worker_details->address->do && !$worker_details->address->type_of_document)
                    <tr>
                        ...
                        <td><a href="{{ route('res-proof', ['worker_id' => encrypt($worker_details->worker_id)]) }}"
                               class="href" target="_blank"><i class="fa fa-external-link"
                                                               aria-hidden="true"></i>&nbsp;View Attachment</a>
                        </td>
                ...
                {{-- @if ($worker_details->already_registered == 1)
                    <tr>
                        ...
                        <td>Work Book</td>
                        <td><a href="{{ route('work-book', ['worker_id' => encrypt($worker_details->worker_id)]) }}"
                                class="href" target="_blank"><i class="fa fa-external-link"
                                    aria-hidden="true"></i>&nbspView Attachment</a></td>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('bank-pass', ['worker_id' => encrypt($worker_details->worker_id)]) }}"
                           class="href" target="_blank"><i class="fa fa-external-link"
                                                           aria-hidden="true"></i>&nbsp;View Attachment</a>
                    </td>
                ...
                @if ($worker_details->already_payment_status == true)
                    <tr>
                        ...
                        <td><a href="{{ route('ack-pay-slip', ['worker_id' => encrypt($worker_details->worker_id)]) }}"
                               class="href" target="_blank"><i class="fa fa-external-link"
                                                               aria-hidden="true"></i>&nbsp;View Attachment</a></td>
