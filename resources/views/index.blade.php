...
@section('style')
    ...
    <style>
        ...
        .ministerBox {
            background: linear-gradient(45deg, #f8f9ff, #ffeecb);
            border-radius: 15px;
            padding: 20px;
            margin-bottom: 20px;
            border-left: 4px solid #ffad16;
        ...
        .ministerBox:hover {
            ...
            box-shadow: 0 15px 30px rgb(255 247 233);
            border-left-color: #f09f0a;
        }
        ...
        .ministerBox:hover img {
            ...
            box-shadow: 0 12px 25px rgb(254 239 207);
        }
        ...
        .content-card {
            background: linear-gradient(135deg, #fff 0%, #fef8ee 100%);
        ...
        .content-card::before {
            ...
            width: 100%;
            height: 4px;
            background: linear-gradient(90deg, #facc74, #ffad16);
        }
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title d-flex align-items-center gap-2" id="languageModalLabel">
                        <i class="fa fa-language fa-lg"></i> &nbsp; Select Your Language
                    </h5>
                ...
                <div class="modal-body text-center position-relative">
                    ...
                    <img src="{{ asset('assets/template/images/languages.png') }}" id="langu">
                    <p>ৱেবছাইটৰ বাবে আপোনাৰ সুবিধাৰ ভাষা বাছক </p>
                    <div class="language-options">
                        <ul class="list-unstyled d-flex justify-content-center gap-4">
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <li>
                                    <div class="custom-radio">
                                        <input type="radio" id="lang_{{ $localeCode }}" name="language"
                                        ...
                                        <label class="custom-radio-label" for="lang_{{ $localeCode }}">
    ...
    <div class="container-fluid banner-card">
        <div>
            @php
                $cards = [
                    [
                        'image' => asset('assets/template/images/registration1.png'),
                    ...
                    [
                        'image' => asset('assets/template/images/registration2.png'),
                        'icon' => 'bi bi-person-vcard',
                        'title' => __('index.constructionworker'),
                    ...
                    [
                        'image' => asset('assets/template/images/registration3.png'),
                        'icon' => 'bi bi-person-vcard',
                        'title' => __('index.constructionworker'),
                        'subtitle' => __('index.applyonlineforclaim'),
                        'modal' => '#claim-modal',
                        'circle-bg-color' => '#00bcd4',
                    ],

                    [
                        'image' => asset('assets/template/images/registration4.png'),
                        'title' => __('index.CESSpayee/Collector'),
                        'subtitle' => __('index.LogintoProceedRegistration'),
                        'modal' => '#cess-modal',
                        'circle-bg-color' => '#f2cc5d',
                    ],
                ];
            @endphp
                        ...
                        <div class="card-flex mobile">
                            <div class="card border-0 text-center">
                                @if (filter_var($card['modal'], FILTER_VALIDATE_URL))
                                    ...
                                    @else
                                        <div data-toggle="modal" data-target="{{ $card['modal'] ?? '' }}"
                                            class="card-body">
                                @endif
    ...
    @if ($contents->isNotEmpty() || $index_notifications->isNotEmpty())
        <section class="mymar">
            <div class="container position-relative">
                <img src="{{ asset('assets/template/images/mar2.png') }}" id="marshadow">
                <img src="{{ asset('assets/template/images/notice.png') }}" id="noticeImg">
                <marquee class="marquee" scrollamout="6" onmouseover="this.stop()" onmouseout="this.start()">
                    {{-- <a href="{{ route('home.iit') }}">
                <img src="{{ asset('assets/template/images/index/new.gif') }}" alt="New"
                    ...
                    @endforeach
                    <a href="{{ asset('assets/template/video/csc_assamese.mp4') }}" target="_blank">
                        <img src="{{ asset('assets/template/images/index/new.gif') }}" alt="Video 1"
                            style="width:50px; cursor:pointer;"> ROLL OUT of CSC for Nirman Sakhi Portal(Assamese)
                    </a>
                    <a href="{{ asset('assets/template/video/csc_english.mp4') }}" target="_blank">
                        <img src="{{ asset('assets/template/images/index/new.gif') }}" alt="Video 1"
                            style="width:50px; cursor:pointer;"> ROLL OUT of CSC for Nirman Sakhi Portal(English)
                    </a>
                </marquee>
            </div>
        </section>
                ...
                <div class="col-md-8">
                    <div class="welcome">
                        <div class="welcomeImage " style="padding:20px;float:left;min-width: 200px;">
                            ...
                            <div class="content">
                                <img src="{{ asset('assets/template/images/assam.png') }}" alt="assam buildings"
                                    id="assam">
                                <h3 id="wel">Welcome to</h3>
                                <h2 class="welcomeHeading">{{ trans('index.welcometo') }}</h2>

                                <h4 class="welcomeSubHeading">
                                    {{ trans('index.abocwwb') }} </h4>

                                <p>{{ trans('index.assam_board_info') }}</p>
                                <p>{{ trans('index.assam_board_info2') }}</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                ...
                                <div class="row px-4">
                                    <div class="col-md-12 ">
                                        <h3 class="mt-4 mb-4 font-weight-500 splitText" id="guideline">
                                                        ...
                                                        <div class="w-100 d-flex align-items-center"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="rounded-circle d-flex justify-content-center align-items-center"
                                                                    style="height: 50px; width: 50px; background:linear-gradient(45deg, #00c6ff, #0072ff); border-radius: 50%;">
                    ...
                    <div class="row bord-benits px-4 benefits-section">
                        <div class="col-12">
                            <h2 class="benefits-title mb-2 splitText">Benefits provided by the Board
                            </h2>
                            <p style="color: #444; font-size: 17px; margin-bottom: 28px;">
                            ...
                            <div class="row benifit-grid">
                                @php
                                    $benefits = [
                                        ...
                                        ['icon' => 'fa-cog', 'text' => 'Skill Development Training'],
                            ...
                            <a href="about/benefits" class="btn btn-outline-primary mt-5" style="font-weight: 600;">
                                <i class="fa fa-hand-o-right" aria-hidden="true"></i> View benefit details
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 sidebar sticky-section shadow">
                    <div class="mt-0">
                        <div class="minister">
                            ...
                            <div class="ministerBox">
                                <img src="{{ asset('assets/template/images/index/Rameswar.jpeg') }}" alt="Image 2">
                                <div class="ministerText">
                        ...
                        <div class="sticky-section-content mt-3">
                                    ...
                                    <div class="marquee">
                                        <div class="marquee-content">
                                            @foreach ($index_notifications as $index_notification)
                                                <a href="{{ asset($index_notification->pdf_path) }}" target="_blank">
                                    ...
                                    <div class="marquee">
                                        <div class="marquee-content">
                                            @foreach ($index_newsletters as $index_newsletter)
                                                <a href="{{ asset($index_newsletter->pdf_path) }}" target="_blank">
                                                    <img src="{{ asset('assets/template/images/index/new.gif') }}"
                                                        alt="New" style="width: 50px;">
                            ...
                            <div class="content-card p-4 mt-4 mb-1 rounded">
                                        ...
                                        <div class="marquee-content">
                                            ...
                                            @foreach ($index_tenders as $index_tender)
                                                <a href="{{ asset($index_tender->pdf_path) }}" target="_blank">
                                                    <img src="{{ asset('assets/template/images/index/new.gif') }}"
                                                        alt="New" style="width: 50px;"> {{ $index_tender->caption }}
                                ...
                                {{-- <marquee behavior="" direction="up" onmouseover="this.stop()"
    ...
    <div class="modal fade" id="renewal-modal">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg overflow-hidden">
                <!-- Modal Header -->
                <div class="modal-header border-0 bg-gradient-primary px-4 py-3">
                    <h5 class="modal-title text-white fw-semibold fs-4">
                        {{ trans('index.workerrenewal') }}
                    </h5>
                ...
                <div class="modal-body p-0">
                    <div class="row g-0">
                        <!-- Left Info Panel -->
                        <div class="col-12 col-lg-6 bg-light p-4">
                            <div class="info-section">
                                <!-- Requirements Section -->
                                <div class="mb-4">
                                    <h6 class="text-primary fw-bold mb-3">{{ trans('sop2.head1') }}</h6>
                                    <ul class="list-unstyled">
                                        @foreach (['head1point1', 'head1point2', 'head1point3', 'head1point4'] as $point)
                                            <li class="mb-2 d-flex align-items-start">
                                                <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                                <span>{{ trans('sop2.' . $point) }}</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                                ...
                                <!-- Documents Section -->
                                <div class="mb-4">
                                    <h6 class="text-primary fw-bold mb-3">{{ trans('index.documents') }}</h6>
                                    <div class="document-item d-flex align-items-center gap-3 bg-white p-3 rounded-3">
                                        <i class="fas fa-file-alt text-primary fs-4"></i>
                                        <div class="flex-grow-1">
                                            <p class="mb-2">Updated worker's record book (new format)</p>
                                ...
                                <div class="alert alert-warning d-flex align-items-center" role="alert">
                                    ...
                                    <small>Only original document copies are allowed for scanning and uploading.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6 bg-white p-4">
                            <div class="form-section">
                                <form id="worker-renewal-form" action="{{ route('auth.worker') }}" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <label class="form-label fw-semibold">{{ trans('index.idcardnum') }}</label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light border-end-0">
                                                <i class="fas fa-id-card text-primary"></i>
                                            </span>
                                            <input type="text" class="form-control border-start-0" name="id_card"
                                                placeholder="{{ trans('index.enteridcard') }}" />
                                        </div>
                                        <div id="otp_sent_message_renwal" class="form-text"></div>
                                    </div>

                                    <!-- OTP Section -->
                                    <div id="otp_form_renewal" class="mb-4" style="display: none;">
                                        <label class="form-label fw-semibold">Enter OTP</label>
                                        <div class="d-flex gap-2 justify-content-center mb-3">
                                            @for ($i = 1; $i <= 6; $i++)
                                                <input type="number" id="otp_{{ $i }}"
                                                    class="form-control text-center fw-bold"
                                                    style="width: 45px; height: 45px;" maxlength="1" />
                                            @endfor
                                        </div>
                                        <div id="timer" class="text-center text-muted">
                                            <small>Code expires in: <span id="countdown">03:00</span></small>
                                        </div>
                                    </div>

                                    <!-- Action Buttons -->
                                    <div class="d-grid gap-2">
                                        <button type="submit" id="get_otp_renewal" class="btn btn-primary">
                                            <i class="fas fa-paper-plane me-1"></i>
                                            Get OTP
                                        </button>
                                        <button type="button" id="verify_otp_renewal_index" class="btn btn-success"
                                            style="display: none;">
...
@section('footer')
    ...
    @if (session()->has('pfcData'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                var pfcdata = @json(session('pfcData'));
                console.log(pfcdata);
                ...
                } else if (pfcdata.service_id === ['2', '3']) {
                    alert('Renewal loaded');
                    {{-- @isset($id_cards) --}}
    ...
    <script>
            ...
            $('#track-form').submit(function(event) {
                ...
                $.ajax({
                    ...
                    .done(function(response) {
                        ...
                        var is_renewal = response[0].is_renewal;
        ...
        <button class="btn btn-danger btn-sm"
            onclick="reApply('${worker_id}', ${already_reg_status})">
            <i class="fa fa-refresh"></i> Re-Submit
        </button>
    ` : `
        <div class="alert alert-warning text-center mb-0" style="font-size:14px;">
            <strong>Note:</strong> Re-submission is not allowed for renewal applications.
            Please log in to continue.
        </div>
    `
                        ) : latestStatus === "D" && is_renewal === 0 ? `
...
${idCardNumber ? `
        ...
        function getStatusText(status, re_route = 0) {

            // If re-routed and status is B
            if (status === 'B' && re_route == 1) {
                return 'Re-routed To Concerned Office';
            }
    ...
    <script>
        // Nirman Sakhi welcome heading
        let welcomeHeading = document.querySelector(".welcomeHeading").textContent;
        let splittedText = welcomeHeading.split("");
        var ourtext = "";
        splittedText.forEach((elm) => {
            ourtext += `<span>${elm}</span>`;
        });
        document.querySelector(".welcomeHeading").innerHTML = ourtext;

        let spans = document.querySelectorAll(".welcomeHeading span");
        spans.forEach(span => {
        ...
        //marquee animated image
        document.addEventListener("DOMContentLoaded", function() {
            const marqsection = document.querySelector(".mymar");
            const noticeImg = document.querySelector("#noticeImg");

            marqsection.addEventListener("mouseenter", () => {
                noticeImg.src = "{{ asset('assets/template/images/notice2.gif') }}";
                noticeImg.style.transform = "scale(1.4)";
            });

            marqsection.addEventListener("mouseleave", () => {
                noticeImg.src = "{{ asset('assets/template/images/notice.png') }}";
                noticeImg.style.transform = "scale(1)";
            });
        });
    </script>
    <script type="text/javascript">
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    const langEl = document.getElementById('languageModal');
    if (!langEl || typeof bootstrap === 'undefined') return;

    const langModal = (bootstrap.Modal.getInstance(langEl) || new bootstrap.Modal(langEl));

    // Delegate clicks inside the language modal
    langEl.addEventListener('click', function (ev) {
        const btn = ev.target.closest('[data-dismiss="modal"], .close, .close-language-modal');
        if (!btn) return;
        ev.preventDefault();
        ...
        // If button also wants to open another modal (v4 data-target or v5 data-bs-target)
        const targetSelector = btn.getAttribute('data-target') || btn.getAttribute('data-bs-target');
        const toggle = btn.getAttribute('data-toggle') || btn.getAttribute('data-bs-toggle');
        if (toggle === 'modal' && targetSelector) {
            // wait for hide animation to finish then show target
            setTimeout(() => {
                const nextEl = document.querySelector(targetSelector);
                if (nextEl) {
                    (bootstrap.Modal.getInstance(nextEl) || new bootstrap.Modal(nextEl)).show();
                }
            }, 300);
        }
    });
