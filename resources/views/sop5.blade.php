    ...
    <div class="container mt-5" id="b-homedb">
        ...
        <div class=" mt-4 " style="text-align: justify;">
            ...
            <ol class="my-2">
                ...
                <li>If the 90-day certificate is found to be fake, revert the application with necessary comments /
                    observations.</li>
                <li>In case of any other crucial information found fake regarding the eligibility criteria, revert the
...
<br>
            ...
            <ol class="my-2">
                ...
                <li>If the workbook details are found to be fake, revert the application with necessary comments /
                    observations.</li>
                <li>In case of any other crucial information found fake regarding the eligibility criteria, revert the
                    application with necessary comments / observations.</li>
            </ol>
