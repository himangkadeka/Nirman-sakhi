...
@section('style')
    ...
    <style type="text/css">
        ...
        * {
        ...
        rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;/ /td {
            /
...
@section('content')
                        ...
                        <div class="card rounded-card">
                            <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                ...
                                <span>
                                    ...
                                    {{ trans('worker-registration/worker-registration-address.residential') }}
                                    &nbsp;({{ trans('worker-registration/worker-registration-address.applicationno') }}-
                                    {{ $formdata->application_no }})
                                </span>

                            </div>

                            <form action="{{ route('submit-address') }}" class="form-group ml-2 mr-2" method="post">
                                ...
                                <div class="mt-3"
                                    ...
                                    <h5 class="mt-4 d-flex align-items-center" style="color: #007bff;">
                                        ...
                                        <span style="color: #495057; margin-left: 8px;"></span>
                                    </h5>
                                    ...
                                    <div class="form-row mt-5"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            <label for="inputFirstName"
                                                class="">{{ trans('worker-registration/worker-registration-address.state') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
    ...
    <i class="fa fa-check-circle"></i>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputLastName"
                                                class="">{{ trans('worker-registration/worker-registration-address.district') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                                  style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4"
                                                class="">{{ trans('worker-registration/worker-registration-address.subdistrict') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                                     style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="permanentRoad"
                                                class="">{{ trans('worker-registration/worker-registration-address.postoffice') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                                    style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                    ...
                                    <div class="form-row mt-3"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            <label for="inputDob"
                                                class="">{{ trans('worker-registration/worker-registration-address.locality') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                                  style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputMstatus"
                                                class="">{{ trans('worker-registration/worker-registration-address.villagearea') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                                     style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputAge"
                                                class="">{{ trans('worker-registration/worker-registration-address.landmark') }}</label>
    ...
    <i class="fa fa-check-circle"></i>
                                    ...
                                    <div class="form-row mt-3"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            <label for="inputAge"
                                                class="">{{ trans('worker-registration/worker-registration-address.pin') }}</label><span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                             style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
    <i class="fa fa-check-circle"></i>
                                                {{ trans('worker-registration/worker_basic_details.aadhaar') }}
        </span>
                                ...
                                <div class="form-row d-flex-center mb-4 mt-4"><!--start 1-->
                                    <div class="d-flex align-items-center"
                                        ...
                                        <label for="copyAddressCheckbox" class="ml-3 mr-3 mb-0">
                                            <span
                                                style="font-size: 1rem; font-weight: 600; color: #495057;">{{ trans('worker-registration/worker-registration-address.copyaddress') }}
                                            </span>
                                            <br>
                                ...
                                <div class="mt-3"
                                    ...
                                    <div class="form-row mt-4"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            <label for="currentResidence"
                                                class="">{{ trans('worker-registration/worker-registration-address.residencetype') }}</label><span
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputLastName"
                                                class="">{{ trans('worker-registration/worker-registration-address.housetype') }}
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4"
                                                class="">{{ trans('worker-registration/worker-registration-address.houseno') }}
                                            </label>
                                            <input type="text"
                                        ...
                                        {{-- <div class="form-group col-md-3">
                                            <label for="road"
                                                class="bold">{{ trans('worker-registration/worker-registration-address.street') }}</label><span
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="currentCity"
                                                class="">{{ trans('worker-registration/worker-registration-address.locality') }}</label><span
                                                style="color:red;">*</span>
                                            <input type="text"
                                    ...
                                    <div class="form-row mt-3"><!--start 1-->
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="gender"
                                                class="">{{ trans('worker-registration/worker-registration-address.villagearea') }}
                                            </label><span style="color:red;">*</span>
                                            <input type="text"
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputCategory"
                                                class="">{{ trans('worker-registration/worker-registration-address.postoffice') }}
                                            </label><span style="color:red;">*</span>
                                            <input type="text"
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputAge"
                                                class="">{{ trans('worker-registration/worker-registration-address.subdistrict') }}
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputAge"
                                                class="">{{ trans('worker-registration/worker-registration-address.district') }}</label><span
                                                class="text-danger">*</span>
                                            <select
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputPhone"
                                                class="">{{ trans('worker-registration/worker-registration-address.pin') }}
                                            </label><span class="text-danger">*</span>
                                            <input type="text"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-1 clearfix mt-4">
                                    <div class="ml-auto d-inline-block align-self-center mr-2">
                                        ...
                                        <button type="submit" id="submitBtn" class="btn btn-sm btn-primary" disabled>
                                            <i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;
                                            {{ trans('worker-registration/worker-registration-address.saveaddress') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
...
@section('footer')
    ...
    {{-- Script to handle copying current address --}}
    <script>
