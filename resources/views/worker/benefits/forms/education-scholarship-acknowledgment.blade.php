    ...
    <div id="page-content-wrapper">
        ...
        <div class="ack-container">
            ...
            <div class="ack-details">
                ...
                @if ($submission->benefit->benefit_code=='EA' || $submission->benefit->benefit_code=='FA' || $submission->benefit->benefit_code=='DB')
                    <p><strong>Applicant Name:</strong> {{ $applicantVaultDetails['name'] }}</p>
                @endif
