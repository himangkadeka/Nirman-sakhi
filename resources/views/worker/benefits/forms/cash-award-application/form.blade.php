        ...
        <div class="container py-5">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Application for Cash Award For Education</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('submit-benefit-application', $benefit_id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="application_date" class="form-control bg-light"
                                    value="{{ $submitted_data->application_date ? $submitted_data->application_date->format('Y-m-d') : date('Y-m-d') }}"
                                    readonly>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="hidden" name="district_id" id=""
                                    value="{{ $submitted_data->district_id }}">
                                <input type="text" name="district_name" class="form-control bg-light"
                                    value="{{ $submitted_data->district->district_name }}" disabled>

                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Name of Applicant (Worker)</label>
                                <input type="text" class="form-control bg-light" value="{{ $getVaultData['name'] }}"
                                    readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>BOCW Registration No.</label>
                                <input type="text" class="form-control bg-light" value="{{ $id_card }}"
                                    readonly>
                            </div>
                        ...
                        <h6 class="text-primary font-weight-bold border-bottom pb-2 mb-3 mt-4">2. Student Information
                        </h6>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label>Name of Student <span class="text-danger">*</span></label>
                                <input type="text" name="student_name" class="form-control bg-light"
                                    value="{{ $applicantVaultDetails['name'] }}" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="student_age" class="form-control bg-light"
                                    value="{{ \Carbon\Carbon::parse($applicantVaultDetails['dob'])->age }}" readonly>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="social_category" class="form-control" required>
                                    ...
                                    @foreach (\App\Models\Category::get() as $category)
                                        <option value="{{ $category->category_code }}" {{-- Logic: Check Old Input -> Check Draft -> Check nothing --}}
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <textarea name="parent_address" class="form-control" rows="1" required>{{ old('parent_address', $submitted_data->parent_address ?? $applicantVaultDetails['careOf'] . ', ' . $applicantVaultDetails['landMark'] . ', ' . $applicantVaultDetails['locality'] . ', PO-' . $applicantVaultDetails['postOffice'] . ', PIN-' . $applicantVaultDetails['pinCode']) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="university_board" class="form-control"
                                    ...
                                    value="{{ old('university_board', $submitted_data->university_board ?? '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="course_duration_years" class="form-control"
                                    placeholder="e.g. 3"
                                    value="{{ old('course_duration_years', $submitted_data->course_duration_years ?? '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Date of Admission <span class="text-danger">*</span></label>
                                <input type="date" name="admission_date" class="form-control"
                                    value="{{ old('admission_date', optional($submitted_data->admission_date ?? null)->format('Y-m-d') ?? '') }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="qualifying_exam_name" class="form-control"
                                    ...
                                    value="{{ old('qualifying_exam_name', $submitted_data->qualifying_exam_name ?? '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="qualifying_exam_board" class="form-control"
                                    ...
                                    value="{{ old('qualifying_exam_board', $submitted_data->qualifying_exam_board ?? '') }}"
                                    required>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="month" name="qualifying_exam_year" class="form-control"
                                    value="{{ old('qualifying_exam_year', $submitted_data->qualifying_exam_year ?? '') }}"
                                    required>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="exam_marks[{{ $i }}][total]"
                                                    class="form-control form-control-sm mark-total"
                                                    value="{{ old('exam_marks.' . $i . '.total', $savedMarks[$i]['total'] ?? '100') }}"
                                                    min="0" max="1000">
                                            </td>
                                            <td>
                                                <input type="number"
                                                    name="exam_marks[{{ $i }}][obtained]"
                                                    class="form-control form-control-sm mark-obtained"
                                                    value="{{ old('exam_marks.' . $i . '.obtained', $savedMarks[$i]['obtained'] ?? '') }}"
                                                    min="0">
                                            </td>
                                            <td>
                                                <input type="number" step="0.01"
                                                    name="exam_marks[{{ $i }}][percentage]"
                                                    class="form-control form-control-sm mark-percentage" readonly
                        ...
                        <h6 class="text-primary font-weight-bold border-bottom pb-2 mb-3 mt-4">5. Bank & Contribution
                            Details</h6>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="parents_are_beneficiaries" class="form-control" required>
                                    ...
                                    <option value="1"
                                        {{ old('parents_are_beneficiaries', $submitted_data->parents_are_beneficiaries ?? 0) == 1 ? 'selected' : '' }}>
                                        Yes</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Contribution Payment valid upto <span class="text-danger">*</span></label>
                                <input type="date" name="last_contribution_date" class="form-control"
                                    value="{{ old('last_contribution_date', optional(\App\Models\MainWorkerForm::where('id_card', $id_card)->first())->subscription_validity_date ? \Carbon\Carbon::parse(\App\Models\MainWorkerForm::where('id_card', $id_card)->first()->subscription_validity_date)->format('Y-m-d') : '') }}"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="account_number" class="form-control"
                                    value="{{ old('account_number', $submitted_data->account_number ?? '') }}"
                                    required>
                            </div>
                        </div>
                            ...
                            @foreach ($documents as $field => $label)
                                <div class="col-md-6 mb-4">
                                    ...
                                    @if (!empty($submitted_data->$field))
                                        <div class="mb-2">
                                            <a href="{{ asset('storage/' . $submitted_data->$field) }}"
                                                target="_blank" class="badge badge-success p-2">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (tableBody) {
            tableBody.addEventListener('input', function(e) {
                // Check if the changed element is a Total or Obtained input
                if (e.target.classList.contains('mark-total') || e.target.classList.contains('mark-obtained')) {

                    // Find the parent row for context
                    const row = e.target.closest('tr');

                    // Get the input elements for this specific row
                    const totalInput = row.querySelector('.mark-total');
                    const obtainedInput = row.querySelector('.mark-obtained');
                    const percentageInput = row.querySelector('.mark-percentage');

                    if (totalInput && obtainedInput && percentageInput) {
                        let totalVal = parseFloat(totalInput.value) || 0;
                        let obtainedVal = parseFloat(obtainedInput.value) || 0;

                        // 1. Enforce Max 1000 on Total
                        if (totalVal > 1000) {
                            totalVal = 1000;
                            totalInput.value = totalVal; // Update field visibly
                        }

                        // 2. Set HTML5 max attribute for form validation
                        obtainedInput.setAttribute('max', totalVal);

                        // 3. Enforce Obtained <= Total
                        if (obtainedVal > totalVal) {
                            obtainedVal = totalVal;
                            obtainedInput.value = obtainedVal; // Cap the field visibly
                        }

                        // 4. Calculate Percentage using the corrected values
                        if (totalVal > 0) {
                            let percentage = (obtainedVal / totalVal) * 100;
                            percentageInput.value = percentage.toFixed(2);
                        } else {
                            percentageInput.value = ''; // Clear if total is 0 or empty
                        }
                    }
                }
            });
