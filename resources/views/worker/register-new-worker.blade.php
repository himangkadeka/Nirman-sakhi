                        ...
                        <div class="container-fluid">
                            <div class="card rounded-card">
                                <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                    ...
                                    <span>
                                        <i class="fa fa-plus-circle"
                                            aria-hidden="true"></i>&nbsp;{{ trans('worker-registration/worker_new_registration.title') }}
                                    </span>
                                </div>
                                <div class="form-check mt-3 mb-3">
                                    <div class="newreg">
                                        <form action="{{ route('worker-reg') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                                        ...
                                                        <div class="card shadow-sm mb-4 flex-fill">
                                                            <div class="card-header bg-light">
                                                                <h5 class="mb-0 font-weight-bold">
                                                                    ...
                                                                    {{ trans('worker-registration/worker_new_registration.office_details') }}
                                                                </h5>
                                                            </div>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="font-weight-semibold">
                                                                        {{ trans('worker-registration/worker_new_registration.district') }}
                                ...
                                {{ $errors->first('district') }}
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="font-weight-semibold">
                                                                        {{ trans('worker-registration/worker_new_registration.office') }}
                                                                        <span class="text-danger">*</span>
                                                                    </label>
                                ...
                                {{ $errors->first('office_id') }}
                                                    ...
                                                    <div class="col-lg-6 d-flex flex-column">
                                                        ...
                                                        <div class="card shadow-sm mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="font-weight-semibold">
                                                                        {{ trans('worker-registration/worker_new_registration.aadhar_consent') }}
                                                                        <span class="text-danger">*</span>
                                                                    </label>
                                    ...
                                    <span id="spinner"
                                          ...
                                          style="display:none;"></span>
                                                        ...
                                                        <!-- OTP Verification -->
                                                        <div id="otpVerification" class="card shadow-sm mb-4" style="display:none;">
                                                            <div class="card-header bg-light">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mt-3">
                                                                    <button type="button" class="btn btn-success px-4" id="submitOTP">
                                                                        Submit OTP
                                                                    </button>

                                                                    <button type="button" class="btn btn-sm btn-secondary ml-2"
                                                                            id="resendOtpButton"
                                                                            disabled>{{ trans('worker-registration/worker_new_registration.resentotp') }}&nbsp;<i
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center mt-3">
                                                        <button type="submit"
                                                                id="register-btn-worker"
                                                                class="btn btn-primary px-4"
                                                                style="display:none;">
                                                            {{ trans('worker-registration/worker_new_registration.regnow') }}
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="noreg" style="display: none;">
                                <div class="row justify-content-md-center mt-2 ml-5">

                                    <div class="form-group col-md-12 col-sm-12 mr-4">
                                        <label for="inputDob"
                                            class="bold">{{ trans('worker-registration/worker_new_registration.entertempid') }}</label>&nbsp;<span
                                            class="text-danger" style="font-size:20px;">*</span>
                                        <input type="text" class="form-control" name="temp_worker_id"
                                            id="temp_worker_id" value="{{ old('temp_worker_id') }}"
                                            placeholder="{{ trans('worker-registration/worker_new_registration.entertempregid') }}"
                                            oninput="this.value = this.value.toUpperCase()">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-center mb-3">
                                    <button type="button" class="btn btn-sm btn-warning temp-id" id="submit-temp-form"
                                        aria-label="Proceed">
...
@section('footer')
    ...
    <audio id="audio-player"
        src="{{ URL::asset('assets/template/audioconsent/aadhaar_consent_audio.mp3') }}"type="audio/mp3"
        preload="auto"></audio>
    @if (session('alert'))
        <script>
            Swal.fire({
    ...
    <script>
        $(document).ready(function() {
            $('#submit-temp-form').on('click', function() {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        temp_worker_id: $('#temp_worker_id').val(),
                        _token: '{{ csrf_token() }}'
                    },
                    success: function(response) {
                        $('#loading-spinner').addClass('d-none');
                        $('#submit-temp-form').prop('disabled', false);

                        if (response.status === 'success' || response.status ===
                            'proceed_to_login' || response.status === "pending") {
                ...
                {{--if (district_code) {--}}
                    {{--$.ajax({--}}
                        ...
                        {{--success: function(data) {--}}
                            ...
                            {{--console.log(data);--}}
                            {{--$(dis).html(--}}
                                {{--'<option value="">--{{ trans('worker-registration/worker_new_registration.selectoffice') }}--</option>'--}}
                            {{--);--}}
