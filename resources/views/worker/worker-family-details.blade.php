                        ...
                        <div class="card rounded-card">
                            ...
                            <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                ...
                                <span>
                                    ...
                                    ({{ trans('worker-registration/worker-family-details.appno') }}
                                    -
                                    ...
                                    <form method="post" id="dynamic_field" action="{{ route('save-family-details') }}"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fixed-width"><input type="text"
                                                                ...
                                                                name="first_name[]" id="fname" value=""
                                                                placeholder="{{ trans('worker-registration/worker-family-details.enterfname') }}" />
                                                        ...
                                                        <td class="fixed-width"><input type="text" name="last_name[]"
                                                                id="lname"
                                                                placeholder="{{ trans('worker-registration/worker-family-details.enterlname') }}"
                                                                value=""
                                                                class="form-control custom-bottom-border lastname  @if ($errors->has('last_name[]')) is-invalid @endif" />

                                                            <span class="text-danger success" id="last_name.0_error"></span>
                                                        </td>

                                                        <td>
                                                            <input type="text" id="date_1" data-id="1"
                                                                name="dob[]"
                                                        ...
                                                        <td class="fixed-width"><input type="text" data-id="1"
                                                                ...
                                                                name="age[]"
                                                                onchange="toggleGuardianName('age_1', 'dropdown_1', 'guardain_name_1');"
                                                                readonly
                                                                placeholder="{{ trans('worker-registration/worker-family-details.age') }}" />

                                                        </td>
                                                        <td class="fixed-width">
                                                            <select name="nominee[]" data-id="1" id="dropdown_1"
                                                                onchange="togglePercentageInput(1); toggleGuardianName('age_1', 'dropdown_1', 'guardain_name_1');"
                                                                class="form-control nominee-input @if ($errors->has('nominee[]')) is-invalid @endif">
                                                                <option value="">
                                                                    {{ trans('worker-registration/worker-family-details.select') }}
                                                                </option>
                                                                <option value="0">
                                                        ...
                                                        <td class="fixed-width"><input type="text" readonly
                                                                name="guardain_name[]" id="guardain_name_1"
                                                        ...
                                                        <td class="fixed-width">
                                                            <input type="number" id="percent_1" min="0"
                                                                oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"
                                                                name="nominee_percentage[]" data-id="1"
                                                                class="form-control percentage-input" readonly
                                                                placeholder="{{ trans('worker-registration/worker-family-details.enterpercentage') }}" />
                                                            <span class="text-danger success"
                                                        ...
                                                        <td>
                                                            <select name="already_registered_state[]" data-id="1"
                                                                ...
                                                                onchange="validateBocwID(1)" disabled
                                        ...
                                        <button type="button" name="add" id="add"
                                            class="btn btn-sm btn-info mt-3"><i
                                                class="fa fa-plus-circle"></i>&nbsp;{{ trans('worker-registration/worker-family-details.addnew') }}
                                        </button>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-1 clearfix mt-4">
                                            <div class="ml-auto d-inline-block align-self-center mr-2">
                                                <a type="submit" href="{{ route('save-address') }}"
                                                    class="btn btn-sm btn-warning" id="saveBtn"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            <td>
                <input
                    ...
                    readonly
                    onchange="toggleGuardianName('age_${index}', 'dropdown_${index}', 'guardain_name_${index}');"
                />
        ...
        function validatePercentages(changedId) {
            ...
            if (per > 100) {
                Swal.fire({
                    icon: 'error',
                    text: 'Total nominee share cannot exceed 100',
                });
        ...
        function validateBocwID(number) {
            const stateSelect = document.getElementById('already_registered_state_' + number);
            const bocwInput = document.getElementById('bocwwb_' + number);
        ...
        function calculateAge(input, number) {
            ...
            if (age < 18) {
                ...
                Toastify({
                    text: "Guardian name is not required when age is more than 18",
                    duration: 3000,
                    gravity: "top",
                    position: "right",
                    backgroundColor: "light-blue", // Green for success
                }).showToast();
                guardianField.value = 'NA';
