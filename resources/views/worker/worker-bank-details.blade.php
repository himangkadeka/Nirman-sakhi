                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card rounded-card">
                            <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                ...
                                <span>
                                    <i class="fa fa-plus-circle" aria-hidden="true"></i>{{ trans('worker-registration/worker-bank-details.bankdetails') }}
                                   &nbsp;| ({{ trans('worker-registration/worker-bank-details.applicationno') }} -
                            ...
                            <div class="mr-2 mt-3 ml-2"
                                ...
                                <p style="margin: 0;">
                                    <strong>2.</strong><span class="text-danger"> {{ trans('worker-registration/worker-bank-details.mandatory2') }}
                                        </span>
                                </p>
                            </div>
                            <div class="form-row mt-4 ml-2"><!--start 1-->
                                <div class="form-group col-md-4">
                                    <label for="inputIfsc">{{ trans('worker-registration/worker-bank-details.ifsccode') }}</label><span
                                        style="color:red;">*</span>
                                    <div class="input-group mb-3 ">
                                        <input type="text"
                                            class="search-input custom-bottom-border form-control uc-text-smooth @if ($errors->has('ifsc')) is-invalid @endif"
                                            name="ifsc" id="ifsc" maxlength="11" placeholder="{{ trans('worker-registration/worker-bank-details.enterifsc') }}"
                                            required />
                                        <div class="input-group-append">
                                            <input type="button" value="{{ trans('worker-registration/worker-bank-details.searchbankdetails') }}" id="populateBank"
                                                class="btn-sm btn-danger proceed">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('save-bank-details') }}" id="bankForm" class="form-group ml-2 mr-2"
                                method="post">
                                @csrf
                                ...
                                <div class="form-row mt-2"><!--start 1-->
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputBankAddress">{{ trans('worker-registration/worker-bank-details.bankaddress') }}
                                            </label><span style="color:red;">*</span>
                                        <input type="text" class="form-control custom-bottom-border uc-text-smooth bank"
                                            id="bank_address" name="bank_address" value="{{ old('bank_address') }}"
                                ...
                                <div class="form-row mt-4"><!--start 1-->
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputAcc">{{ trans('worker-registration/worker-bank-details.accountnumber') }}
                                            </label><span style="color:red;">*</span>
                                        <div class="input-group">
                                            <input type="text" class="form-control custom-bottom-border" id="account_no"
                                                name="account_no" value="{{ old('account_no') }}" maxlength="20"
                                                placeholder="{{ trans('worker-registration/worker-bank-details.enteraccountnumber') }}">
                                            {{--                                        <div class="input-group-append"> --}}
                                            {{--                                            <button type="button" class="btn btn-outline-secondary btn-sm" --}}
                                            {{--                                                onclick="toggleVisibility('account_no', 'toggleAccountNo')"> --}}
                                            {{--                                                <i class="fa fa-eye" id="toggleAccountNo"></i> --}}
                                            {{--                                            </button> --}}
                                            {{--                                        </div> --}}
                                        </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="inputAge">{{ trans('worker-registration/worker-bank-details.confirmaccountnumber') }}

                                            </label><span style="color:red;">*</span>
                                        <div class="input-group">
                                            <input type="text" class="form-control custom-bottom-border"
                                                id="account_no_confirmation" name="account_no_confirmation"
                                                value="{{ old('account_no_confirmation') }}" maxlength="20"
                                                placeholder="{{ trans('worker-registration/worker-bank-details.enterconfirm') }}">
                                            {{--                                        <div class="input-group-append"> --}}
                                            {{--                                            <button type="button" class="btn btn-outline-secondary btn-sm" --}}
                                            {{--                                                onclick="toggleVisibility('account_no_confirmation', 'toggleAccountNoConfirmation')"> --}}
                                            {{--                                                <i class="fa fa-eye" id="toggleAccountNoConfirmation"></i> --}}
                                            {{--                                            </button> --}}
                                            {{--                                        </div> --}}
                                        </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-1 clearfix mt-4">
                                    <div class="ml-auto d-inline-block align-self-center mr-2">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-primary"><i
                                                ...
                                                {{ trans('worker-registration/worker-bank-details.savebankdetails') }} </button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
@section('footer')
    ...
    <script src="{{ URL::asset('assets/template/js/worker-bank-details-styles.js') }}"></script>
...
//            console.log(ifsc)
    ...
    <script>
        function toggleVisibility(fieldId, toggleIconId) {
            const field = document.getElementById(fieldId);
            const toggleIcon = document.getElementById(toggleIconId);

            if (field.classList.contains('masked-input')) {
