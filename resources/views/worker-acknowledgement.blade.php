                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 " style="display: flex;">
                            <p>
                                ...
                                <span>Receipt Date: <span class="text-danger">{{ $mfb->created_at }}</span></span><br>
...
{{--                                        class="text-danger">{{ $mwf->payment_status }}</span></span><br>--}}
        ...
        <div class="d-flex justify-content-center">
            <a href="{{ url('/') }}" class="btn btn-danger mt-3 mb-3"><i class="fa fa-undo"
...
{{--    @include('components.worker.payment.payment-receipt-initiation')--}}
    ...
    @if (session()->has('pfcData'))
        <form action="{{ $url }}" name="frm1" id="rtps-form" method="post" target="_blank" style="display:none;">
