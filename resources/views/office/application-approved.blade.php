            ...
            <div class="row text-center pl-4" id="sortable-cards">
                <div class="col-lg-12 col-sm-12 p-3 b-customize">
                    <div class="bg-light p-4 b-dbcard">
                        ...
                        <div class="">
                            <h5 class="text-left font-weight-normal"><i class="fa fa-file-text text-success" aria-hidden="true"></i>&nbsp;Applications Approved :</h5>
...
{{--                                            </td>--}}
                                            <td>@if($application->status == 'F')<span class="badge badge-success">Approved</span>@endif</td>
                                        </tr>
                                        </tbody>
                                    @endforeach
                                </table>
