                ...
                <div class="col-lg-12 col-sm-12 p-3 b-customize">
                    <div class="bg-light p-4 b-dbcard">
                        ...
                        @elseif($type == 'manual')
                            ...
                            <h5>User Manual</h5>
                            <p>Click below to view or download the PDF</p>
                            <button onclick="viewPDF('{{asset('assets/template/pdf/DAManual.pdf')}}')" class="btn btn-primary">View PDF</button>
                            <a href="{{asset('assets/template/pdf/DAManual.pdf')}}" download class="btn btn-success">Download PDF</a>
                        @endif
