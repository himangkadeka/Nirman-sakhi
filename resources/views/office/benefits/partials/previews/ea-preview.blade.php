<div class="container py-5">
    <div class="card shadow border-primary">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <span class="badge badge-light text-primary">Form IV</span>
        </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    <tr>
                        ...
                        <td>{{ $application->application_date ? \Carbon\Carbon::parse($application->application_date)->format('d-m-Y') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <th>District</th>
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">{{ \Carbon\Carbon::parse($application->admission_date)->format('d-m-Y') }}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="table-responsive mb-3">
                <table class="table table-sm table-bordered text-center">
                    ...
                    <tbody>
                        @php
                            $marks = is_array($application->exam_marks)
                                ? $application->exam_marks
                                : json_decode($application->exam_marks, true);
                            $grandTotal = 0;
                            $grandObtained = 0;
                        @endphp
