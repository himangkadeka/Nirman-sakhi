...
@section('content')
    <div class="nirman-sahi-dashboard-container mx-5">
        ...
        <div id="processing" class="tab-content active">
            ...
            <div class="mb-3">
                <button type="button" class="btn btn-success" id="openAssignModalBtn">Assign Selected to DA for PPA Dispatch</button>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (submitAssignmentBtn) {
                submitAssignmentBtn.addEventListener('click', function() {
                    ...
                    fetch("{{ route('office.head-office.applications.assignToDaforPPA') }}", {
                            method: 'POST',
                            headers: {
