        ...
        <div id="dlc-content" class="tab-content active">
            ...
            <h3 style="margin-top:20px;">
                @if (Auth::user()->role_id == 16)
                    Applications Forwarded to Labour Commissioner
                @elseif(Auth::user()->role_id == 17)
                    Applications Forwarded to Labour Minister
                @endif
                                ...
                                <div class="btn-group">
                                    ...
                                    @if (Auth::user()->role_id == 16)
                                        <button class="btn btn-success btn-sm shadow-sm forward-single-btn"
                                            data-id="{{ $app->id }}" data-bs-toggle="tooltip" title="Forward to LM">
                                            <i class="fas fa-share"></i>
                                        </button>
                                    @elseif(Auth::user()->role_id == 17)
                                        <button class="btn btn-success btn-sm shadow-sm forward-single-btn"
                                            data-id="{{ $app->id }}" data-bs-toggle="tooltip" title="Approve">
