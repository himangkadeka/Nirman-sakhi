    ...
    <div class="nirman-sahi-dashboard-container mx-5">
        ...
        <div id="accounts" class="tab-content active">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <p>The following batches are forwarded to DLC for review</p>
                            ...
                            <tbody>
                                @forelse($pendingSignatureBatches as $batch)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse(\App\Models\PpaBatchFile::where('batch_id', $batch->batch_id)->first()->accounts_signed_at)->format('d-M-Y h:i A') }}
                                        </td>
