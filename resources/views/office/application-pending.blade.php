    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="my-5" id="b-homedb">
                ...
                <div class="container">
{{--                    <h4 class="text-center mb-3 b-latest-data">&nbspApplication Pending</h4>--}}
            ...
            <div class="row text-center pl-4" id="sortable-cards">
                <div class="col-lg-12 col-sm-12 p-3 b-customize">
                    <div class="bg-light p-4 b-dbcard">
                        ...
                        <div class="">
                            <h5 class="text-left font-weight-light"><i class="fa fa-file-text text-danger" aria-hidden="true"></i>&nbspApplications Pending :</h5>
                                ...
                                <table class="table table-bordered table-secondary text-sm-center" id="myTable">
                                    ...
                                    @foreach($data as $key=> $application)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('office-applications',['id' =>encrypt($application->worker_id)])}}" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    @endforeach
