                    ...
                    <div class="bg-light p-4 b-dbcard">
                        ...
                        <div class="">
                            ...
                            <div class="table-responsive mt-4">
                                @if(count($data) > 0)
                                <table class="table table-striped table-bordered text-sm-center" id="myTable">
                                    ...
                                    @foreach($data as $key => $application)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($application->status == 'F')
                                                    <span class="badge badge-success">Approved</span>
                                                @elseif($application->status == 'D')
                                                    <span class="badge badge-danger">Rejected</span>
                                                @elseif($application->status == 'A')
                                                    <span class="badge badge-warning">Submitted & Pending</span>
                                                @endif
                                            </td>
                                            <td>
                                                @if($application->already_registered == 1)
                                                    <span class="badge badge-danger">Already Registered</span>
                                                    @elseif($application->already_registered == null)
                                                    <span class="badge badge-success">New Registration</span>
                                                    @endif
                                            </td>
                                            <td>
                                                <a href="{{route('office-applications',['id' =>encrypt($application->worker_id)])}}">
