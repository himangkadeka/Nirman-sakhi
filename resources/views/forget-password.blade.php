                        ...
                        <div class="container-fluid">
                            <div class="card rounded-card">
                                <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                    ...
                                    <span>
                                        <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp; Forget Password
                                    </span>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-md-12 px-5">
                                                <div class="form-group">
                                                    <label for="username_reset" class="bold">User Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="username_reset"
                                                        name="username_reset" placeholder="Enter your username">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button type="button" id="get-otp" class="btn btn-primary">Get
                                                    Otp</button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 px-5" id="otp-reset-send-msg" style="display: none;">
                                                <p class="text-success">Otp sent to your mobile number ending with <span
                                                        id="mobile_reset"></span></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 px-5" id="otp-inputs" style="display: none;">
                                                <div class="form-group">
                                                    <label for="otp" class="bold">Otp <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" maxlength="6" class="form-control" id="otp-for-reset"
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12" id="otp-inputs" style="">
                                                <p id="resend_timer_reset" style="display: none"> Resend OTP in <span
                                                        id="timer_reset" class="text-success">180 </span> Seconds</p>

                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 px-5 text-center">
                                                    <button type="button" style="display: none" id="verify-otp-reset" class="btn btn-primary"><span
                                                            id="otp-text" >Verify Otp</span></button>
                                                    <button type="button" id="resend_otp_reset"
                                                        class="btn btn-primary"
                                                        style="display: none;">&nbspResend OTP</button>
            ...
            function sendOtp(no) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $("#get-otp").show();
                        $("#verify-otp-reset").hide(); // Show button again if there's an error
                    }
                });
            }
            // Prevent form submission
