...
@section('title', 'Existing | Schemes')
    ...
    <div class="container-fluid mb-4">
        <div class="col-md-12" style="overflow-x:auto;">
            ...
            <div class="card mt-2">
                ...
                <span>
                    <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; {{ trans('worker-registration/worker-schemes-details.otherschemes') }}
                </span>
                            </div>
                            <form method="post" id="dynamic_field" class="form-group mr-2 ml-2" action="{{ route('save-existing-scheme') }}"
                                ...
                                <div class="form-row mt-4"><!--start 1-->
                                    ...
                                    <div class="form-group col-md-12">
                                        <label class="ml-4 bold" style="margin-bottom: 10px;font-size: 15px;"><i class="fa fa-bullhorn"
                                                                                                 aria-hidden="true"></i>&nbsp;
                                                                                                 {{ trans('worker-registration/worker-schemes-details.question') }} <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="registration_id[]"
                                                       value="{{ old('registration_id') }}" class="form-control " />
                                            ...
                                            <td>
                                                <button type="button" name="remove" id=""
                                                        class="btn btn-sm remove"><i class="fa fa-trash"style="color:red;"
