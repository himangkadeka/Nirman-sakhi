                ...
                <span>
                    <i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;{{ trans('worker-registration/worker-bank-details.updatebankdetails') }}
                            ...
                            <div class="form-row mt-4 ml-2 d-flex align-items-center">
                                ...
                                <div class="col-auto">
                                    <input type="text" class="search-input custom-bottom-border form-control uc-text-smooth mr-1" name="ifsc" id="ifsc"  maxlength="11" value="{{$formdata->ifsc_code}}" />
                                </div>
                                <div class="col-auto">
                                    <input type="button" value="Search Bank Details" id="populateBank" class="btn-sm btn-info proceed" />
                                </div>
                            </div>
                    <form action="{{route('update-existing-bank-details')}}" id="bankForm" class="form-group  ml-2" method="post">
                        @csrf
                        ...
                        <div class="form-row mt-3"><!--start 1-->
                            <div class="form-group col-md-4">
                                <label for="inputBank">{{ trans('worker-registration/worker-bank-details.bankname') }}</label><span style="color:red;">*</span>
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputBranch">{{ trans('worker-registration/worker-bank-details.branch') }}</label><span style="color:red;">*</span>
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputBankAddress">{{ trans('worker-registration/worker-bank-details.bankaddress') }}</label><span style="color:red;">*</span>
                        ...
                        <div class="form-row mt-4"><!--start 1-->
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputAcc">{{ trans('worker-registration/worker-bank-details.accountnumber') }}</label><span style="color:red;">*</span>
                                <input type="text" class="form-control custom-bottom-border" id="account_no" name="account_no" value="{{$formdata->account_no}}" maxlength="20" placeholder="Enter Account Number">
                            ...
                            <div class="form-group col-md-4">
                                <label for="inputAge">{{ trans('worker-registration/worker-bank-details.confirmaccountnumber') }}</label><span style="color:red;">*</span>
                                <input type="text" class="form-control custom-bottom-border" id="account_no_confirmation" value="{{$formdata->account_no}}" maxlength="20" placeholder="Confirm Account Number" name="account_no_confirmation" >
