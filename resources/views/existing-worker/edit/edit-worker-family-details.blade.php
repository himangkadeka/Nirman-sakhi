                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($formdata as $key => $familyMember)
                                                            <tr>
                                                                <td><span class="badge badge-danger">{{ $key + 1 }}</span></td>
                                                                ...
                                                                <td class="fixed-width"><input type="text" data-id="1"
                                                                        ...
                                                                        name="age[]"  onchange="checkProf(this); toggleGuardianName('age_1', 'dropdown_1', 'guardain_name_1');"
                                                                        readonly /></td>
                                                                ...
                                                                <td>
                                                                    <select name="already_registered_state[]"
                                                                        ...
                                                                        <option
                                                                            ...
                                                                            {{ $familyMember->state_name ?? 'Select State' }}</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dynamic_field').submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route('update-existing-family-details') }}',
                    method: 'POST',
                    data: formData,
