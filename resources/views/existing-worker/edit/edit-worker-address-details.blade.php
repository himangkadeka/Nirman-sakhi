                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="card rounded-card">
                            <div class="card-header card-header-bg text-white d-flex justify-content-between align-items-center"
                                ...
                                <span>
                                    <i class="fa fa-plus-circle"
                                        aria-hidden="true"></i>&nbsp;{{ trans('worker-registration/worker-registration-address.updateresidentialaddress') }}
                                </span>
                            </div>
                            @if($remarks)
                                <div>
                            ...
                            @endif
                            <form action="{{ route('update-existing-address-details') }}" class="form-group ml-2 mr-2"
                                method="post">
                                @csrf
                                <div class="mt-3"
                                ...
                                <div class="mt-4"
                                    ...
                                    <div class="form-row mt-5"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            ...
                                            >{{ trans('worker-registration/worker-registration-address.state') }}</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            >{{ trans('worker-registration/worker-registration-address.postoffice') }}</label>
                                            <span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                     style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
                                                {{ trans('worker-registration/worker-registration-address.aadhaar') }}</span>
                                    ...
                                    <div class="form-row mt-3"><!--start 1-->
                                        <div class="form-group col-md-3">
                                            ...
                                            >{{ trans('worker-registration/worker-registration-address.villagearea') }}</label>
                                            <span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                                                                                                      style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
                                                {{ trans('worker-registration/worker-registration-address.aadhaar') }}</span>
                                            <input type="text" class="form-control custom-bottom-border uc-text-smooth"
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="gender"
                                            >{{ trans('worker-registration/worker-registration-address.street') }}
                                            </label> <span class="badge bg-success text-light position-relative top-0 end-0 mt-1 me-1"
                                                           style="font-size: 10px; padding: 6px 10px; border-radius: 12px;">
                                                {{ trans('worker-registration/worker-registration-address.aadhaar') }}</span>
                                            <input type="text" class="form-control custom-bottom-border uc-text-smooth"
                                                id="p_street" name="p_area"
                                                value="{{ $getVaultData['street'] ? $getVaultData['street'] : 'NA' }}"
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <div class="d-flex justify-content-center align-items-center"
                                        ...
                                        <input class="ml-3" type="checkbox" name="do"
                                            value="{{ $formdata->do }}" class="form-check-input"
                                            id="copyAddressCheckbox" onclick="handleCheckboxClick()"
                                    ...
                                    <div class="form-row mt-3"><!--start 1-->
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control custom-bottom-border state"
                                                data-id="c" id="currentState" name="c_state" onchange="validateCurrentState()"
...
@section('footer')
    ...
    <script>
        ...
        //     if (checkbox.checked) {
        //         handleCheckboxClick(); // Simulate a click to lock fields
        //     }
        ...
        function handleCheckboxClick() {
            ...
            if (checkbox.checked) {
                ...
                copyPermanentToCurrent(true); // Lock fields
            } else {
                radios.forEach((radio) => {
                    radio.disabled = false;
                });
                clearCurrentAddress(); // Unlock and clear fields
            }
        }


        // Helper function to set fields readonly
        function setFieldsReadonly(readonly) {
            const currentFields = [
                'currentState', 'currentDist', 'currentCircle', 'currentPost',
                'currentArea', 'currentRoad', 'currentCity', 'landmark',
                'currentPin', 'currentBuildingName'
            ];
