        ...
        <div class="card p-4 shadow-lg" style="width: 100%; max-width: 600px;">
            ...
            <form id="otpForm">
                <div class="mb-3">
                    ...
                    <input type="hidden" value="{{$worker_id}}" id="hiddenWorkerIdEx">
                    <input
                        type="tel"
                        id="mobileNumber"
                        class="form-control"
...
{{--            </div>--}}
{{--            <div>--}}
                <button class="btn btn-success w-30 mt-1" id="login-with-tempId-Ex" style="display: none;">Login <i class="fa fa-sign-in"></i></button>
            </div>
        </div>
...
@section('footer')
    <script>
        ...
        $('#login-with-tempId-Ex').on('click', function(e) {
            e.preventDefault();
            ...
            if (workerId) {
                ...
                $.ajax({
                    url: "{{ route('login-with-temp-id-ex') }}",
                    type: 'post',
                    data: {
