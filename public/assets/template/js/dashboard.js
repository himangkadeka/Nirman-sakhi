...
if(ctx1) {
	var myChart1 = new Chart(ctx1, {
	    type: 'bar',
	    data: {
	        labels: ['Public sector banks', 'Regional rural banks', 'Private sector banks', 'Total'],
	        datasets: [{
	            label: 'Total deposits by sector (as of may 2020)',
	            data: [1026.08, 248.88, 39.49, 1314.45],
	            backgroundColor: [
	                'rgba(255, 99, 132, 0.8)',
	                'rgba(54, 162, 235, 0.8)',
	                'rgba(255, 206, 86, 0.8)',
	    ...
	    options: {
	        scales: {
	            yAxes: [{
	                ...
	                scaleLabel: {
						display: true,
						labelString: 'Value in billion Indian Rupees',
						fontSize: '16',
					},
	            }],
	            xAxes: [{
...
if(ctx22) {
	var myChart22 = new Chart(ctx22, {
	    type: 'doughnut',
	    data: {
	        labels: ['Public Sector Banks', 'Regional Rural Banks', 'Private Sector Banks'],
	        datasets: [{
